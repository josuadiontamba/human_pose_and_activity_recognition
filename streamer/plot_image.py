...
def cv_plot_image(img, scale=1, upperleft_txt=None, upperleft_txt_corner=(10, 100),
    ...
    plt.show()
    """
    # from stream.filesystem import try_import_cv2
    ...
    second = end - start
    fps = 1/second
    cv2.putText(canvas, str(fps), (10,20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 1)
