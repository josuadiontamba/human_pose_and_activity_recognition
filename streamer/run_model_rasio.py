...
def keypoint_detection(img, detector, pose_net, mymodel, ctx):
    ...
    if len(upscale_bbox) > 0:
        ...
        diag_x = (bounding_boxs[0][0][0].asscalar() - central_x) ** 2
        diag_y = (bounding_boxs[0][0][1].asscalar() - central_y) ** 2
        ...
        for x in coord:
            ...
            rasio = distance / diag
            distance_from_central.append(round(rasio, 6))
...
if __name__ == '__main__':
    ...
    # pose_path = '/home/jos/tf_lab/Ultralight-SimplePose/trainer/SGD_model.sav'
    # pose_path = '/home/jos/tf_lab/Ultralight-SimplePose/trainer/SVM_model.sav'
